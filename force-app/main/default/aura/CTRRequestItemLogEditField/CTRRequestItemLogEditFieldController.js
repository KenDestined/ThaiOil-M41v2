                               ...
                               if (state === "SUCCESS") 
                               {
                                   ...
                                   if(result)
                                   {
                                       if(!component.get('v.RelatedObj'))
                                       {
                                           ...
                                           component.set('v.TRCRPositionName', result.mTRCRPositionName);
                                           ...
                                           if(component.get('v.historyType') == 'Initial' || component.get('v.historyType') == 'Edit')
                                           {
                                               ...
                                               if(component.get('v.historyType') == 'Initial')
                                               {
                                                   ...
                                                   mNewValueHeader = component.get('v.TRCRPositionName')+' Value';
                                           ...
                                           else if(component.get('v.historyType') == 'Shareholder')
                                           {
                                               ...
                                               {
                                                   component.set('v.HeaderCard', 'Edit Destination of the Product (Ship-To Country)');
