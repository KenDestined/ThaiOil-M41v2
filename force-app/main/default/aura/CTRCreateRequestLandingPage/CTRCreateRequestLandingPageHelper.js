            ...
            if (state === 'SUCCESS') {
                ...
                if (result) {
                    if (result.mResultMessage == 'Success') {
                        // var compare = (a, b) => {
                        //     if (a.mDeveloperName < b.mDeveloperName) {
                        //         return -1;
                        //     }
                        //     if (a.mDeveloperName > b.mDeveloperName) {
                        //         return 1;
                        ...
                        if(result.mRecordTypeList.length > 0) {
                            var test = result.mRecordTypeList.sort((a,b) => (a.mDeveloperName > b.mDeveloperName) ? 1 : ((b.mDeveloperName > a.mDeveloperName) ? -1 : 0))
                            console.log('Sorted recordtype ',test,result.mRecordTypeList)
                        }
